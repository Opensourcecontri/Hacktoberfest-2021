"""
This is a free improvement of the Word Guesser classic game. 
This game is called AHORCADO GAME, and it cantake a file with a single word 
for each row as a list of words for the game.
